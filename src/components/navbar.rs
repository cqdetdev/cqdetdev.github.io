        ...
        <nav class="bg-persian-red">
                ...
                <div class="relative flex h-16 items-center justify-between">
                    ...
                    <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                        ...
                        <div class="flex space-x-4">
                            ...
                            <a href="https://github.com/cqdetdev/" class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">{"Github"}</a>
                            <a href="https://github.com/cqdetdev/cqdetdev.github.io" class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">{"Source"}</a>
            ...
            <div class="sm:hidden" id="mobile-menu">
                <div class="space-y-1 px-2 pb-3 pt-2">
                    ...
                    <a href="https://github.com/cqdetdev/" class="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">{"Github"}</a>
                    <a href="https://github.com/cqdetdev/cqdetdev.github.io" class="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">{"Source"}</a>
